...
/// Loading is cancelled.
  MTRGAdLoadingErrorLoadingCancelled = 4002,
/// Undefined submodel loading error.
  MTRGAdLoadingErrorUndefinedSubmodelLoadingError = 4003,
...
/// Disclaimer types
typedef SWIFT_ENUM_NAMED(NSInteger, MTRGDisclaimerType, "DisclaimerType", open) {
  MTRGDisclaimerTypeUndefined = 0,
  MTRGDisclaimerTypeAlcohol = 3,
  MTRGDisclaimerTypeBeer = 4,
  MTRGDisclaimerTypeTobacco = 5,
  MTRGDisclaimerTypeMedical = 6,
  MTRGDisclaimerTypeDrugs = 8,
  MTRGDisclaimerTypeDietary = 9,
  MTRGDisclaimerTypeDeclaration = 10,
  MTRGDisclaimerTypeCredits = 11,
  MTRGDisclaimerTypeBankruptcy = 12,
  MTRGDisclaimerTypeEnergetics = 13,
};
...
SWIFT_CLASS_NAMED("InstreamAdVideoMotionData")
...
SWIFT_CLASS_NAMED("InstreamAdVideoMotionDisclaimer")
...
@class NSURL;
SWIFT_CLASS_NAMED("InstreamAdVideoMotionHeader")
...
SWIFT_CLASS_NAMED("InstreamAdVideoMotionItem")
...
@protocol MTRGMenu
/// Add menu item model to your storage.
/// \param action MTRGMenuAction object
///
- (void)addMenuAction:(MTRGMenuAction * _Nonnull)action;
/// Present menu using passed items.
...
SWIFT_CLASS("_TtC11MyTargetSDK14MTRGMenuAction")
...
/// Factory for MTRGMenu.
SWIFT_PROTOCOL("_TtP11MyTargetSDK15MTRGMenuFactory_")
